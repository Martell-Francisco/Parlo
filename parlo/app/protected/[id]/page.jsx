    ...
    <div className="flex-1 w-full flex flex-col gap-20 items-center">
        ...
        <div className={styles.folderContainer}>
            {group.map((groups)=>(
                    ...
                    <Link key={groups.group_id}  href={`/protected/${groups.group_id}`}>
                    <div className={styles.folder}>
                        ...
                        <h2 className={styles.h2}>{groups.name}</h2>
                    </div>
        ...
        <div >
            {list.map((lists)=>(
                    ...
                    <Link key={lists.id}  href={`/protected/${params.id}/${lists.id}`}>
                        {console.log("list ID: " + lists.id)}
                    <div className={styles.folder}>
                        <img alt="svgImg" src="/list.svg"/>
                        <h2 className={styles.h2}>{lists.name}</h2>
                    </div>
